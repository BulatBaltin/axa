...
{
    FILE_SYSTEM::provideDirFiles(CSS . 'auto', 
    new class {
        function handle($file) {
            echo "
    <link href=\"/css/auto/{$file}\" rel=\"stylesheet\">";
        }
    }, 'css');
    echo "\n";
}
public static function LinkMetaData()
{
    ...
    $file = $module . '/meta.link';
    $the_file = BUNDLE . $file;
...
// [=========]
    ...
    public static function getProductSnippet(
        ...
        /*$rating_product_score,
    $rating_max_score,
    $rating_review_number,*/
    ) {
