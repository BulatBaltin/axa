...
<ul class="nav">
    <li class="nav-item nav-dropdown">
        ...
        <ul class="nav-dropdown-items ml-3">
            <li class="nav-item">
                <a href="<? path('administrators') ?>" class="nav-link ">
                    <i class="fa-fw fas fa-unlock-alt nav-icon"></i>
                    Administrators
                </a>
            </li>
            <li class="nav-item">
                <a href="<? path('students') ?>" class="nav-link ">
                    <i class="fa-fw fas fa-briefcase nav-icon"></i>
                    Students
                </a>
            </li>
            <li class="nav-item">
                <a href="<? path('teachers') ?>" class="nav-link ">
            ...
            <li class="nav-item">
                <a href="<? path('models') ?>" class="nav-link ">
                    <i class="fa-fw fas fa-user nav-icon"></i>
                    Models
                </a>
            </li>
            <li class="nav-item">
                <a href="<? path('customers') ?>" class="nav-link ">
                    <i class="fa-fw fas fa-user nav-icon"></i>
                    Haircutter customers
                </a>
            </li>
        </ul>
    </li>
...
Model planning
Manage enrollments
AUto create invoices in external system(moneybird)
Materials stock -->