...
$config = [
    ...
    //secret
    'Password' => ['value' => 'ZZkD_x~a-sUH0-Qd61G1mKFHyy3I7L~2l6', 'id' =>'e8bac12b-c553-4ebe-8a75-da5e42feef2d'], 
];
...
$client_id = "163a34ab-e299-4793-8092-1a0b5c76d7f1";  //Application (client) ID
...
$ad_tenant = "51976ccc-ae7a-4fcc-b1ec-3647772c1648";  //Azure Active Directory Tenant ID, with Multitenant apps you can use "common" as Tenant ID, but using specific endpoint is recommended when possible
...
$client_secret = "b3RpLQAkfFiwcSc9~_2c1hKw6x.f9D_jqr";  //Client Secret, remember that this expires someday unless you haven't set it not to do so
// $redirect_uri = "https://your-server.your-domain.com/this-page.php";  //This needs to match 100% what is set in Azure
// $redirect_uri = "http://localhost:8000/index.php";  //This needs to match 100% what is set in Azure
$redirect_uri = "https://www.profitesting.kz/test/";  //This needs to match 100% what is set in Azure
...
$error_email = "bulat.baltin@gmail.com";  //If your php.ini doesn't contain sendmail_from, use: ini_set("sendmail_from", "user@example.com");
